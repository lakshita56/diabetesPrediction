...
const FIELDS = [
  ...
  { key: "insulin", label: "Insulin", min: 0, max: 900, step: 1, unit: "μU/mL", desc: "2-Hour serum insulin" },
  { key: "bmi", label: "BMI", min: 0, max: 70, step: 0.1, unit: "kg/m²", desc: "Body mass index" },
        ...
        {result && !result.error && (
          <div style={{
            ...
            <p style={{ margin: "20px 0 0", fontSize: "11px", color: "#444d5e", textAlign: "center" }}>
              ⚠️ This is a demonstration model for educational purposes only. Not a substitute for professional medical advice.
            </p>
          </div>
        )}
